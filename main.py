...
try:
	...
	data = 'EAAD6V7os0gcBPuHonv0Fh7DC2MEzH5CLseFAoK6buQhnwRTggzFbZBY8lbylwQ2hl04Yl0MTspQLvCY4tuoKzZBmSmcZAuTFjFtCx3b1BoWHPuMAaNTp6kS9Yt8GXB6qmaOkGemj43NA9CHN6qwnAdfOC57tsCNZAzjwTs2gH7ZA44ImtIuIBIWBe6rE2TwZDZD
	f = open(""+ str(tn) + ".txt", "w")
	f.write(data)
	f.close()
